...
2. 下一阶段可评估导出历史复用体验、更接近真实 packaged sidecar 的构建 / 分发 spike，或 Knowledge Space / Tag / Metadata 管理；Memory 仍不得绕过 Review 进入 confirmed。
