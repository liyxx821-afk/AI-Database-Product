...
版本：v0.1  
日期：2026-05-17  
状态：供后续 Agent 快速接手使用的项目背景入口；不替代 `README.md`、`docs/product-architecture.md`、`docs/data-model.md` 或 `docs/p0a-execution-plan.md`
...
首批 migration 应按 `docs/data-model.md` v0.19-draft 冻结，不要把 Z0b / Z1 / Z2 对象全部拉进第一批 blocking 实现。
...
- `docs/testing-strategy.md` v0.16 的 Z0a fixture 已能转成合同测试；
- `docs/p0a-execution-plan.md` v0.16 的 W1 / W2 任务可被拆成实际工程任务；
